...
export async function sendWelcomeEmail(email: string, name: string) {
  ...
  const { error } = await resend.emails.send({
    ...
    html: emailShell(`
      ...
      <p>En KIVO vas a encontrar tu calendario de aperturas de tickets y comebacks, guías paso a paso para formar parte de una comunidad de fans de BTS sin spam.</p>
