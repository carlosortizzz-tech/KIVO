  ...
  return (
    <>
      <button
        ...
        className="flex items-center justify-center gap-2 w-full border-2 border-accent text-accent2 font-bold text-[13px] rounded-[var(--radius-btn)] py-3 mb-4 transition-transform duration-150 active:scale-[0.98]"
      >
            ...
            {!sent ? (
              <form onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  maxLength={300}
                  required
                  className="w-full bg-sunken border border-border rounded-[var(--radius-btn)] px-3.5 py-3 text-sm mb-3.5 outline-none focus:border-accent"
                />
